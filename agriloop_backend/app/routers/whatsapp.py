...
from app.services.agritech_service import AgriTechService, get_agritech_service
...
async def whatsapp_webhook(
    ...
    agritech_service: AgriTechService = Depends(get_agritech_service)
):
    """
    ...
    handler = WhatsAppHandler(ai_service, weather_service, translation_service, web_search_service, agritech_service)
